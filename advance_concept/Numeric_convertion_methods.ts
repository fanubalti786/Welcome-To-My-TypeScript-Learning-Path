...
let num1: number = 123.456789;
let formattedNum: string = num1.toFixed(2);
...
let num2: number = 123.456789;
let precisionNum: string = num2.toPrecision(4);
...
let num3: number = 123.45;
let strNum: string = num3.toString();
...
let expNum: string = num4.toExponential(2);
...
let str1: string = "10";
let parsedNum: number = parseInt(str1);
...
let parsedFloat: number = parseFloat(str2);
